...
<div class="col-md-3">
	<figure class="card card-product">
		...
		<figcaption class="info-wrap">
            ...
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis risus. Nullam feugiat, turpis at pulvinar vulputate, erat libero tristique tellus, nec bibendum odio risus sit amet ante. Suspendisse nisl. Mauris tincidunt sem sed arcu. Class aptent taciti sociosqu</p>
			<div class="action-wrap">
			

				<div class="price-wrap h5">
                    
					<span class="price-new marginleftprice">$1280</span>
                    <button href="#" class="btn btn-danger btn-sm float-right marginleftbutton">Remove</button>
...
<div class="col-md-3">
	<figure class="card card-product">
      ...
      <div class="action-wrap">
				<div class="price-wrap h5">
					<span class="price-new marginleftprice">$280</span>
					<button href="#" class="btn btn-danger btn-sm float-right marginleftbutton"> Remove </a>
				</div> <!-- price-wrap.// -->
			</div> <!-- action-wrap -->
		</figcaption>
	</figure> <!-- card // -->
...
<div class="col-md-3">
	<figure class="card card-product">
      ...
      <div class="action-wrap">
				<div class="price-wrap h5">
					<span class="price-new marginleftprice">$720</span>
					<button href="#" class="btn btn-danger btn-sm float-right marginleftbutton"> Remove </a>
				</div> <!-- price-wrap.// -->
			</div> <!-- action-wrap -->
		</figcaption>
...
<div class="col-md-3">
	<figure class="card card-product">
      ...
      <div class="action-wrap">
				<div class="price-wrap h5">
					<span class="price-new marginleftprice">$880</span>
					<button href="#" class="btn btn-danger btn-sm float-right marginleftbutton"> Remove </a>
				</div> <!-- price-wrap.// -->
			</div> <!-- action-wrap -->
		</figcaption>
